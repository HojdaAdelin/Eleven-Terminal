...
void about(){
  ...
  cout << "Date of creation: August, 2022" << endl;
  cout << "Version: 2.0" << endl;
  cout << "Hours of work: 5-8 hours" << endl;
  cout << "Building ID: gfr78999fhgk0991" << endl;
  cout << "Version ID: 2.4400GH" << endl;
  cout << "URank: 0.735" << endl;
  cout << "Operation Result Prediction: above 9.01" << endl;
